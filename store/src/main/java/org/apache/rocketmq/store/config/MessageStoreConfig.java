...
public class MessageStoreConfig {
    ...
    @ImportantField
    private String storePathDelayLog = System.getProperty("user.home") + File.separator + "store"
        + File.separator + "delaylog";
    
    @ImportantField
    private String storePathConsumeDelayLog = System.getProperty("user.home") + File.separator + "store"
        + File.separator + "consumedelaylog";
    ...
    private long delayLogInterval = 60*30;
    
    
    private long flushDelayLogInterval = 1000;
    
    private long readDelayLogOnce = 10;
    ...
    private int deleteCommitLogFilesInterval = 1000*3600;
    // ConsumeQueue removal interval
    private int deleteConsumeQueueFilesInterval = 1000*3600;
    private int destroyMapedFileIntervalForcibly = 1000 * 120;
    private int redeleteHangedFileInterval = 1000 * 120;
    // When to delete,default is at 4 am
    @ImportantField
    private String deleteWhen = "04";
    private int diskMaxUsedSpaceRatio = 98;
    ...
    @ImportantField
    private int maxTransferCountOnMessageInMemory = 3200;
    @ImportantField
	...
	public String getStorePathDelayLog() {
		return storePathDelayLog;
	}

	public void setStorePathDelayLog(String storePathDelayLog) {
		this.storePathDelayLog = storePathDelayLog;
	}

	public long getDelayLogInterval() {
		return delayLogInterval;
	}

	public void setDelayLogInterval(long delayLogInterval) {
		this.delayLogInterval = delayLogInterval;
	}

	

	public long getReadDelayLogOnce() {
		return readDelayLogOnce;
	}

	public void setReadDelayLogOnce(long readDelayLogOnce) {
		this.readDelayLogOnce = readDelayLogOnce;
	}

	public long getFlushDelayLogInterval() {
		return flushDelayLogInterval;
	}

	public void setFlushDelayLogInterval(long flushDelayLogInterval) {
		this.flushDelayLogInterval = flushDelayLogInterval;
	}

	public String getStorePathConsumeDelayLog() {
		return storePathConsumeDelayLog;
	}

	public void setStorePathConsumeDelayLog(String storePathConsumeDelayLog) {
		this.storePathConsumeDelayLog = storePathConsumeDelayLog;
	}
