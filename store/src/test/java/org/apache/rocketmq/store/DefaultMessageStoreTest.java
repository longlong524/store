...
public class DefaultMessageStoreTest {
    ...
    @Test
    public void testWriteAndReadScheduleMsg() throws Exception {
        long totalMsgs = 6000;
        QUEUE_TOTAL = 10;
        MessageBody = StoreMessage.getBytes();
        for (long i = 0; i < totalMsgs; i++) {
        		MessageExtBrokerInner msgInner=buildScheduleMessage(i);
        		System.err.println(msgInner.getQueueId());
        ...
        for (long i = 0; i < totalMsgs; i++) {
            ...
            System.err.println(System.currentTimeMillis());
            System.err.println(result.getMessageCount());
            List<ByteBuffer> ll=result.getMessageBufferList();
            if(ll!=null) {
    ...
    //14643+45301=59944
    //20:22:42.000 [pool-1-thread-1] ERROR RocketmqStore - put size 1567:58317:58433:0:0
    ...
    @Test
    public void testWriteScheduleMsg2DelayQueue() throws Exception {
        long totalMsgs = 18000;
        QUEUE_TOTAL = 10;
        MessageBody = StoreMessage.getBytes();
        DelayMessageStore dms=new DelayMessageStore((DefaultMessageStore) this.messageStore);
        dms.load();
        dms.start();
        for (long i = 0; i < totalMsgs; i++) {
        		MessageExtBrokerInner msgInner=buildScheduleMessage(i);
            dms.putMessage(msgInner);
        }
        dms.shutdown();
        System.err.println(System.currentTimeMillis());
    }
    ...
    @Test
    public void testReadScheduleMsg() throws Exception {
        System.err.println(System.currentTimeMillis());
        ...
        for (long i = 0; i < totalMsgs; i++) {
            ...
            GetMessageResult result = messageStore.getMessage("GROUP_B", "FooBar",
            		0, offset, 
            		1024 * 1024, null);
            //System.err.println(System.currentTimeMillis());
